...
local com1_fix1 = 132555 --"132555"
local com1_fix1_name = "Munich Rad -dif"

local com1_fix2 = 128030 --"128030"
local com1_fix2_name = "Munich Rad (APP) -ok"

local com1_fix3 = 118830 --"118830"
local com1_fix3_name = "Munich Arr -no"

local com1_fix4 = 118705 --"118705"
local com1_fix4_name = "Munich Twr -ok"

local com1_fix5 = 121710 --"121710"
local com1_fix5_name = "Munich Gnd -dif"
...
function draw_little_radio()
    ...
    graphics.draw_line(interface_x, interface_y + interface_height, interface_x + interface_width,
        interface_y + interface_height)                                                                                            -- unten
    graphics.draw_line(interface_x + interface_width, interface_y + interface_height, interface_x + interface_width,
        interface_y)                                                                                                               -- rechts
...
function draw_little_radio2()
    ...
    -- Hintergrund zeichnen
    graphics.set_color(0.1, 0.1, 0.1, 0.8) -- weniger transparentes Grau
    graphics.draw_rectangle(interface_x, interface_y + offset_queue1, interface_x + interface_width,
        interface_y + offset_queue1 + interface_height)
    ...
    graphics.draw_rectangle(interface_x, interface_y + offset_queue1, interface_x + 8,
        interface_y + offset_queue1 + interface_height)

    -- Rahmen zeichnen
    graphics.set_color(1, 1, 1, 1)                                                                                                                             -- Weißer Rahmen
    graphics.draw_line(interface_x, interface_y + offset_queue1, interface_x,
        interface_y + offset_queue1 + interface_height)                                                                                                        -- links
    graphics.draw_line(interface_x, interface_y + offset_queue1 + interface_height, interface_x + interface_width,
        interface_y + offset_queue1 + interface_height)                                                                                                        -- unten
    graphics.draw_line(interface_x + interface_width, interface_y + offset_queue1 + interface_height,
        interface_x + interface_width, interface_y + offset_queue1)                                                                                            -- rechts
    graphics.draw_line(interface_x + interface_width, interface_y + offset_queue1, interface_x, interface_y +
    offset_queue1)                                                                                                                                             -- oben

    -- Text anzeigen
    graphics.set_color(1, 1, 1, 1)
    draw_string_Helvetica_12(interface_x + 10, interface_y + offset_queue1 + 30, "Variable 1")
    draw_string_Helvetica_18(interface_x + 10, interface_y + offset_queue1 + 05,
        string.format("%3.3f", com1_queue1 / 1000))
...
function draw_little_radio3()
    ...
    -- Hintergrund zeichnen
    graphics.set_color(0.1, 0.1, 0.1, 0.8) -- weniger transparentes Grau
    graphics.draw_rectangle(interface_x, interface_y + offset_queue3, interface_x + interface_width,
        interface_y + offset_queue3 + interface_height)
    ...
    graphics.draw_rectangle(interface_x, interface_y + offset_queue3, interface_x + 8,
        interface_y + offset_queue3 + interface_height)

    -- Rahmen zeichnen
    graphics.set_color(1, 1, 1, 1)                                                                                                                             -- Weißer Rahmen
    graphics.draw_line(interface_x, interface_y + offset_queue3, interface_x,
        interface_y + offset_queue3 + interface_height)                                                                                                        -- links
    graphics.draw_line(interface_x, interface_y + offset_queue3 + interface_height, interface_x + interface_width,
        interface_y + offset_queue3 + interface_height)                                                                                                        -- unten
    graphics.draw_line(interface_x + interface_width, interface_y + offset_queue3 + interface_height,
        interface_x + interface_width, interface_y + offset_queue3)                                                                                            -- rechts
    graphics.draw_line(interface_x + interface_width, interface_y + offset_queue3, interface_x, interface_y +
    offset_queue3)                                                                                                                                             -- oben

    -- Text anzeigen
    graphics.set_color(1, 1, 1, 1)
    draw_string_Helvetica_12(interface_x + 10, interface_y + offset_queue3 + 30, "Variable 2")
    draw_string_Helvetica_18(interface_x + 10, interface_y + offset_queue3 + 05,
        string.format("%3.3f", com1_queue3 / 1000))
...
function draw_little_radio_fix1()
    ...
    -- Hintergrund zeichnen
    graphics.set_color(0.1, 0.1, 0.1, 0.8) -- weniger transparentes Grau
    graphics.draw_rectangle(interface_x, interface_y + offset_fix1, interface_x + interface_width,
        interface_y + offset_fix1 + interface_height)
    ...
    graphics.draw_rectangle(interface_x, interface_y + offset_fix1, interface_x + 8,
        interface_y + offset_fix1 + interface_height)

    -- Rahmen zeichnen
    graphics.set_color(1, 1, 1, 1)                                                                                                                         -- Weißer Rahmen
    graphics.draw_line(interface_x, interface_y + offset_fix1, interface_x, interface_y + offset_fix1 + interface_height)                                  -- links
    graphics.draw_line(interface_x, interface_y + offset_fix1 + interface_height, interface_x + interface_width,
        interface_y + offset_fix1 + interface_height)                                                                                                      -- unten
    graphics.draw_line(interface_x + interface_width, interface_y + offset_fix1 + interface_height,
        interface_x + interface_width, interface_y + offset_fix1)                                                                                          -- rechts
...
function draw_little_radio_fix2()
    ...
    -- Hintergrund zeichnen
    graphics.set_color(0.1, 0.1, 0.1, 0.8) -- weniger transparentes Grau
    graphics.draw_rectangle(interface_x, interface_y + offset_fix2, interface_x + interface_width,
        interface_y + offset_fix2 + interface_height)
    ...
    graphics.draw_rectangle(interface_x, interface_y + offset_fix2, interface_x + 8,
        interface_y + offset_fix2 + interface_height)

    -- Rahmen zeichnen
    graphics.set_color(1, 1, 1, 1)                                                                                                                         -- Weißer Rahmen
    graphics.draw_line(interface_x, interface_y + offset_fix2, interface_x, interface_y + offset_fix2 + interface_height)                                  -- links
    graphics.draw_line(interface_x, interface_y + offset_fix2 + interface_height, interface_x + interface_width,
        interface_y + offset_fix2 + interface_height)                                                                                                      -- unten
    graphics.draw_line(interface_x + interface_width, interface_y + offset_fix2 + interface_height,
        interface_x + interface_width, interface_y + offset_fix2)                                                                                          -- rechts
...
function draw_little_radio_fix3()
    ...
    -- Hintergrund zeichnen
    graphics.set_color(0.1, 0.1, 0.1, 0.8) -- weniger transparentes Grau
    graphics.draw_rectangle(interface_x, interface_y + offset_fix3, interface_x + interface_width,
        interface_y + offset_fix3 + interface_height)
    ...
    graphics.draw_rectangle(interface_x, interface_y + offset_fix3, interface_x + 8,
        interface_y + offset_fix3 + interface_height)

    -- Rahmen zeichnen
    graphics.set_color(1, 1, 1, 1)                                                                                                                         -- Weißer Rahmen
    graphics.draw_line(interface_x, interface_y + offset_fix3, interface_x, interface_y + offset_fix3 + interface_height)                                  -- links
    graphics.draw_line(interface_x, interface_y + offset_fix3 + interface_height, interface_x + interface_width,
        interface_y + offset_fix3 + interface_height)                                                                                                      -- unten
    graphics.draw_line(interface_x + interface_width, interface_y + offset_fix3 + interface_height,
        interface_x + interface_width, interface_y + offset_fix3)                                                                                          -- rechts
...
function draw_little_radio_fix4()
    ...
    -- Hintergrund zeichnen
    graphics.set_color(0.1, 0.1, 0.1, 0.8) -- weniger transparentes Grau
    graphics.draw_rectangle(interface_x, interface_y + offset_fix4, interface_x + interface_width,
        interface_y + offset_fix4 + interface_height)
    ...
    graphics.draw_rectangle(interface_x, interface_y + offset_fix4, interface_x + 8,
        interface_y + offset_fix4 + interface_height)

    -- Rahmen zeichnen
    graphics.set_color(1, 1, 1, 1)                                                                                                                         -- Weißer Rahmen
    graphics.draw_line(interface_x, interface_y + offset_fix4, interface_x, interface_y + offset_fix4 + interface_height)                                  -- links
    graphics.draw_line(interface_x, interface_y + offset_fix4 + interface_height, interface_x + interface_width,
        interface_y + offset_fix4 + interface_height)                                                                                                      -- unten
    graphics.draw_line(interface_x + interface_width, interface_y + offset_fix4 + interface_height,
        interface_x + interface_width, interface_y + offset_fix4)                                                                                          -- rechts
...
function draw_little_radio_fix5()
    ...
    -- Hintergrund zeichnen
    graphics.set_color(0.1, 0.1, 0.1, 0.8) -- weniger transparentes Grau
    graphics.draw_rectangle(interface_x, interface_y + offset_fix5, interface_x + interface_width,
        interface_y + offset_fix5 + interface_height)
    ...
    graphics.draw_rectangle(interface_x, interface_y + offset_fix5, interface_x + 8,
        interface_y + offset_fix5 + interface_height)

    -- Rahmen zeichnen
    graphics.set_color(1, 1, 1, 1)                                                                                                                         -- Weißer Rahmen
    graphics.draw_line(interface_x, interface_y + offset_fix5, interface_x, interface_y + offset_fix5 + interface_height)                                  -- links
    graphics.draw_line(interface_x, interface_y + offset_fix5 + interface_height, interface_x + interface_width,
        interface_y + offset_fix5 + interface_height)                                                                                                      -- unten
    graphics.draw_line(interface_x + interface_width, interface_y + offset_fix5 + interface_height,
        interface_x + interface_width, interface_y + offset_fix5)                                                                                          -- rechts
