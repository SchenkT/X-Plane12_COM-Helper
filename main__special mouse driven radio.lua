...
local com1_fix1="122800"
local com1_fix1_name="mytext"

local com1_fix2="125750"
local com1_fix2_name="mytext"

local com1_fix3="134375"
local com1_fix3_name="mytext"

local com1_fix4="125750"
local com1_fix4_name="mytext"

local com1_fix5="134375"
local com1_fix5_name="mytext"
...
function draw_little_radio_fix1()
    ...
    -- Text anzeigen
    graphics.set_color(1, 1, 1, 1)
    draw_string_Helvetica_10(interface_x + 10, interface_y +offset_fix1+ 35, com1_fix1_name)
    draw_string_Helvetica_18(interface_x + 10, interface_y +offset_fix1+ 15, string.format("%3.3f", com1_fix1 / 1000))
...
function draw_little_radio_fix2()
    ...
    -- Text anzeigen
    graphics.set_color(1, 1, 1, 1)
    draw_string_Helvetica_10(interface_x + 10, interface_y +offset_fix2+ 35, com1_fix2_name)
    draw_string_Helvetica_18(interface_x + 10, interface_y +offset_fix2+ 15, string.format("%3.3f", com1_fix2 / 1000))
...
function draw_little_radio_fix3()
    ...
    -- Text anzeigen
    graphics.set_color(1, 1, 1, 1)
    draw_string_Helvetica_10(interface_x + 10, interface_y +offset_fix3+ 35, com1_fix3_name)
    draw_string_Helvetica_18(interface_x + 10, interface_y +offset_fix3+ 15, string.format("%3.3f", com1_fix3 / 1000))
...
function draw_little_radio_fix4()
    ...
    -- Text anzeigen
    graphics.set_color(1, 1, 1, 1)
    draw_string_Helvetica_10(interface_x + 10, interface_y +offset_fix4+ 35, com1_fix4_name)
    draw_string_Helvetica_18(interface_x + 10, interface_y +offset_fix4+ 15, string.format("%3.3f", com1_fix4 / 1000))
...
function draw_little_radio_fix5()
    ...
    -- Text anzeigen
    graphics.set_color(1, 1, 1, 1)
    draw_string_Helvetica_10(interface_x + 10, interface_y +offset_fix5+ 35, com1_fix5_name)
    draw_string_Helvetica_18(interface_x + 10, interface_y +offset_fix5+ 15, string.format("%3.3f", com1_fix5 / 1000))
